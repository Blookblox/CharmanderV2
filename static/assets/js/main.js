...
if (window.location.pathname === "/index.html" || window.location.pathname === "/") {
    ...
    const options = [
      ...
      "The #99999 site unblocker, with like 2 users daily",
      "The #99999 site unblocker, with like 2 users daily",
      "Finally, an actual site unblocker that works fast!",
      "Do not share this link with anyone.",
      "Join our community at https://discord.gg/au8uhwPN",
      "Join our community at https://discord.gg/au8uhwPN",
      "© Copyright 2024 Charmander Unblocker. All Rights Reserved.",
      "GET BACK TO WORK!",
